<div>
    <div class="rounded-lg shadow-sm overflow-hidden">
        ...
        <div class="flex justify-between items-center">
            <div class="pb-2">
                <h1 class="text-2xl font-bold text-gray-900"><span class="text-blue-700">Thrift Fund</span> Transactions</h1>
        ...
        <table class="w-full text-sm text-left text-gray-500">
            ...
            <tbody>
                ...
                <tr class="bg-white border-b hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3 text-sm font-medium text-gray-900">{{ $transaction->transaction_id ?? 'N/A' }}</td>
                    <td class="px-4 py-3 text-sm font-medium text-gray-900">{{ $transaction->member->name ?? 'N/A' }}</td>
                    ...
                    <td class="px-4 py-3 text-sm font-medium text-gray-900">₹{{ number_format($transaction->transaction_amount ?? 0, 2) }}</td>
                    <td class="px-4 py-3 text-sm font-medium text-gray-900">{{ \Carbon\Carbon::parse($transaction->transaction_date)->format('d-m-Y') ?? 'N/A' }}</td>
                    <td class="px-4 py-3 text-sm">
                        <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
    ...
    <!-- Transaction Modal -->
    <div id="transactionModal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 {{ $showTransactionModal ? 'block' : 'hidden' }}">
        <div class="bg-white rounded-lg shadow-xl p-8 w-full max-w-2xl mx-4">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-2xl font-bold text-gray-900">{{ $transactionId ? 'Edit' : 'New' }} Thrift Fund Transaction</h2>
            ...
            <form wire:submit.prevent="saveTransaction" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Transaction Name *</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        <label for="transactionNumber" class="block text-sm font-medium text-gray-700 mb-2">Transaction ID *</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        <label for="transactionAmount" class="block text-sm font-medium text-gray-700 mb-2">Amount *</label>
                    ...
                    <div class="mb-4">
                        <label for="transactionDate" class="block text-sm font-medium text-gray-700 mb-2">Transaction Date *</label>
