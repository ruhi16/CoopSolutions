<div>
    ...
    <body class="bg-gray-50">
        <!-- Header Navbar -->
        <header
            class="fixed top-0 left-0 right-0 bg-gradient-to-r from-blue-600 to-purple-600 text-white h-16 flex items-center justify-between px-6 shadow-lg z-50">
            <div class="flex items-center space-x-4">
                <button id="sidebarToggle"
                    class="p-2 rounded-lg hover:bg-white hover:bg-opacity-20 transition-all duration-200">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative">
                    <button id="userMenuToggle"
                        class="flex items-center space-x-2 p-2 rounded-lg hover:bg-white hover:bg-opacity-20 transition-all duration-200">
                        <div
                            class="w-8 h-8 bg-white rounded-full flex items-center justify-center text-blue-600 font-bold">
                            JD
                        </div>
        ...
        <!-- Sidebar -->
        <aside id="sidebar"
            class="fixed left-0 top-16 h-full w-64 bg-white shadow-lg transform transition-transform duration-300 z-40">
            ...
            <nav class="mt-4">
                ...
                <div class="px-4 py-2">
                    <a href="#"
                        class="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 transition-all duration-200 menu-item-active">
                ...
                <div class="px-4 py-2">
                    @foreach($testMenus as $mainMenu)
                        <button
                            class="menu-toggle flex items-center justify-between w-full px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 transition-all duration-200">
                        ...
                        <div class="submenu mt-2 ml-4 space-y-1">
                            @foreach($mainMenu['submenus'] as $subMenu)
                                <button wire:click="setActiveMenu('{{ $subMenu['name'] }}')"
                ...
                <div class="px-4 py-2">
                    ...
                    <div class="submenu mt-2 ml-4 space-y-1">
                        <a href="#"
                            class="flex items-center space-x-3 px-4 py-2 rounded-lg text-gray-600 hover:bg-gray-100 transition-all duration-200">
                        ...
                        <div class="ml-4">
                            <button
                                class="submenu-toggle flex items-center justify-between w-full px-4 py-2 rounded-lg text-gray-600 hover:bg-gray-100 transition-all duration-200">
                                <div class="flex items-center space-x-3">
                            ...
                            <div class="submenu mt-2 ml-4 space-y-1">
                                <a href="#"
                                    class="flex items-center space-x-3 px-4 py-2 rounded-lg text-gray-500 hover:bg-gray-100 transition-all duration-200">
                ...
                <div class="px-4 py-2">
                    <a href="#"
                        class="flex items-center space-x-3 px-4 py-3 rounded-lg text-gray-700 hover:bg-gray-100 transition-all duration-200">
        ...
        <main id="mainContent" class="ml-64 mt-16 p-6 transition-all duration-300">
            ...
            <div class="bg-white rounded-lg shadow-sm p-6 mb-6">
                <div class="flex justify-between items-center">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900">Cooperative Management System</h1>
            ...
            @if($activeMenu != 'dashboard')
                <div class="bg-white rounded-lg shadow-sm p-6">
                    ...
                    @elseif($activeMenu == 'bankLoanSchema')
                        @livewire('ec21-bank-loan-specification')
                    @elseif($activeMenu == 'bankLoanBorrowed')
                        @livewire('ec21-bank-loan-borrowed-comp')

                        {{-- Workflow Management Components --}}
                    @elseif($activeMenu == 'taskCategory')
                        @livewire('wf01-task-category-comp')
                    @elseif($activeMenu == 'taskParticular')
                        @livewire('wf02-task-event-particular-comp')
                    @elseif($activeMenu == 'taskParticularStatus')
                    ...
                    @elseif($activeMenu == 'taskEvent')
                        @livewire('wf03-task-event-comp')
                    @elseif($activeMenu == 'taskSchedule')
                        @livewire('wf08-task-event-schedule-comp')
                    ...
                    @else
                        <div class="text-center py-12">
                            ...
                            <p class="text-gray-600">The selected menu item '{{ $activeMenu }}' does not have an associated
                                component.</p>
