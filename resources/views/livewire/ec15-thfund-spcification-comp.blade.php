<div>
    <div class="rounded-lg shadow-sm overflow-hidden">
        ...
        <div class="flex justify-between items-center">
            <div class="pb-2">
                <h1 class="text-2xl font-bold text-gray-900"><span class="text-blue-700">Thrift Fund</span>
                    Specifications</h1>
        ...
        <table class="w-full text-sm text-left text-gray-500">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 rounded-md">
                <tr class="">
                    ...
                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Effected
                        On</th>
            ...
            <tbody>
                @foreach($specifications as $specification)
                            <tr class="bg-white border-b hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-sm font-medium text-gray-900">{{ $specification->particular ?? 'N/A' }}
                                </td>
    ...
    <div id="specificationModal"
        class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 {{ $showSpecificationModal ? 'block' : 'hidden' }}">
        <div class="bg-white rounded-lg shadow-xl p-8 w-full max-w-2xl mx-4">
            ...
            <form wire:submit.prevent="saveSpecification" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        <label for="name" class="block text-sm font-medium text-gray-700 mb-2">Specification Name
                            *</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        <label for="particularValue" class="block text-sm font-medium text-gray-700 mb-2">Particular
                            Value</label>
