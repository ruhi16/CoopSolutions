<div>
    <div class="rounded-lg shadow-sm overflow-hidden">
        ...
        <div class="flex justify-between items-center">
            <div class="pb-2">
                <h1 class="text-2xl font-bold text-gray-900"><span class="text-blue-700">Thrift Fund</span> Master
                    Database</h1>
            ...
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 rounded-md">
                <tr class="">
                    ...
                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                        Operational Amount</th>
                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Type</th>
                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Current
                        Balance</th>
                    <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Period
                    </th>
                            ...
                            <tr class="bg-white border-b hover:bg-gray-50">
                                ...
                                <td class="px-4 py-3 text-sm font-medium text-gray-900">
                                    @if($masterDb->start_at && $masterDb->end_at)
                                        {{ \Carbon\Carbon::parse($masterDb->start_at)->format('M Y') }} -
                                        {{ \Carbon\Carbon::parse($masterDb->end_at)->format('M Y') }}
    ...
    <!-- Master DB Modal -->
    <div id="masterDbModal"
        class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 {{ $showMasterDbModal ? 'block' : 'hidden' }}">
        <div class="bg-white rounded-lg shadow-xl p-8 w-full max-w-3xl mx-4">
            <div class="flex justify-between items-center mb-6">
                <h2 class="text-2xl font-bold text-gray-900">{{ $masterDbId ? 'Edit' : 'New' }} Master Database Record
                </h2>
            ...
            <form wire:submit.prevent="saveMasterDb" class="space-y-4">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="mb-4">
                        <label for="operationalAmount" class="block text-sm font-medium text-gray-700 mb-2">Operational
                            Amount</label>
                    ...
                    <div class="mb-4">
                        <label for="operationalType" class="block text-sm font-medium text-gray-700 mb-2">Operation
                            Type</label>
                    ...
                    <div class="mb-4">
                        <label for="operationalDate" class="block text-sm font-medium text-gray-700 mb-2">Operation
                            Date</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        <label for="currentBalance" class="block text-sm font-medium text-gray-700 mb-2">Current
                            Balance</label>
                    ...
                    <div class="mb-4">
                        <label for="numberOfMonths" class="block text-sm font-medium text-gray-700 mb-2">Number of
                            Months</label>
        ...
        <div class="bg-white rounded-lg shadow-xl p-6 w-full max-w-md mx-4">
            ...
            <div class="mb-6">
                <p class="text-sm text-gray-600">
                    Are you sure you want to delete this thrift fund master database record? This action cannot be
                    undone.
                </p>
            </div>
