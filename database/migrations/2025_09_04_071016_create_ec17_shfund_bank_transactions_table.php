...
class CreateEc17ShfundBankTransactionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ec17_shfund_bank_transactions', function (Blueprint $table) {
            $table->id();
            $table->string('name');
    ...
    {
        Schema::dropIfExists('ec17_shfund_bank_transactions');
    }
}
